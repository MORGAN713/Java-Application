...
public class UsingMathsClass{
	public static void main(String[] args){
		...
		//output
		System.out.printf("The absolut value of the number is %d %d%n ",Math.abs(num1),Math.abs(num2));
		...
		System.out.printf("The random number is %f%n ",Math.random()*Math.PI());
	}
}